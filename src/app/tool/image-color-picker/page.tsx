          ...
          {showColorDetails && selectedColor && (
            <div className="mt-8 bg-gray-700 rounded-lg p-6 shadow-lg">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-300">
                  HSL: {rgbToHsl(hexToRgb(selectedColor)?.r!, hexToRgb(selectedColor)?.g!, hexToRgb(selectedColor)?.b!).h}°, 
                  {rgbToHsl(hexToRgb(selectedColor)?.r!, hexToRgb(selectedColor)?.g!, hexToRgb(selectedColor)?.b!).s}%, 
                  {rgbToHsl(hexToRgb(selectedColor)?.r!, hexToRgb(selectedColor)?.g!, hexToRgb(selectedColor)?.b!).l}%
                </p>
              </div>
            </div>
          )}  
